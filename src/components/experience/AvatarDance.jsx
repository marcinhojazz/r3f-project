...
const AvatarDance = (props) => {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('./models/AvatarDance.gltf')
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Armature">
          ...
          <skinnedMesh castShadow name="Wolf3D_Glasses" geometry={nodes.Wolf3D_Glasses.geometry} material={materials.Wolf3D_Glasses} skeleton={nodes.Wolf3D_Glasses.skeleton} />
          ...
          <skinnedMesh castShadow name="Wolf3D_Beard" geometry={nodes.Wolf3D_Beard.geometry} material={materials.Wolf3D_Beard} skeleton={nodes.Wolf3D_Beard.skeleton} morphTargetDictionary={nodes.Wolf3D_Beard.morphTargetDictionary} morphTargetInfluences={nodes.Wolf3D_Beard.morphTargetInfluences} />
...
export default AvatarDance

useGLTF.preload('./models/AvatarDance.gltf')
